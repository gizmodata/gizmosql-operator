...
// +kubebuilder:rbac:groups=engines.gizmodata.com,resources=gizmosqlserverclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=engines.gizmodata.com,resources=gizmosqlserverclusters/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=engines.gizmodata.com,resources=gizmosqlserverclusters/finalizers,verbs=update
